...
string choice3 = Console.ReadLine();              //till höger - tredje frågan

if (choice3 == "stanna vid muren")
{
    Console.WriteLine("Någon kastar dig över muren och du slår i huvudet mot en sten. Slut");
}
else if (choice3 == "gå vidare")
{
